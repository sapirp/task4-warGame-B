...
namespace WarGame
{
    ...
    private:
        ...
        Soldier *getSoldier(std::pair<int, int> location);
        void lookForDeads();
    ...
    public:
        ...
        //initialise a 2D vector of numRows rows and numCols column, with a value nullptr.
        ...
        static float dist(const std::pair<int, int> &source, const std::pair<int, int> &soldierLocation);
    };
